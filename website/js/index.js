    ...
    function handleRequest(event) {
        ...
        $.ajax({
            ...
            success: function (data) {
                $("#methodStatus").append('<div class="alert alert-success"><b>Success! WorkSpace request submitted...</b>It will take about 25 mintues, Please do not click the create button again. You may refresh the page for status update. the WorkSpace will be created automatically and an email will be sent to your email with instructions for access.</div>');
                $("#methodStatus").show();
            }
        });
